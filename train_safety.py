...
from training.train_safety import run
...
parser.add_argument("--save_dir", default="./runs/safety", type=str)


# Load
parser.add_argument("--load_buffer", action="store_true")
parser.add_argument("--load_replay_buffer", default="./runs/safety", type=str)
parser.add_argument("--load_models", action="store_true")
parser.add_argument("--load_models_dir", default="./runs/safety", type=str)
